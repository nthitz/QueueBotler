...
(function() {
  ...
  removeIdleUsers = function(pins, queue) {
    var idleTime, idleUser, idleUsers, mins, pin, pinO, queuePerson, timeParts, validLineID, validUserIDs, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _m, _results;
    validUserIDs = [];
    ...
    for (_l = 0, _len3 = idleUsers.length; _l < _len3; _l++) {
      ...
      if (validUserIDs.indexOf(idleUser.userid !== -1)) {
        pinO = null;
        ...
        _results.push(removeQueuedPerson(idleUser, pinO));
      } else {
