...
(function() {
  var $, Bot, ChatManager, DEBUG, PMManager, addToQueue, addToQueueIfNotInQueue, auth, bot, checkIn, checkInIfInList, getQueueMessages, host, http, latestQueue, numberToEmoji, parsePM, pins, processQueueHTML, profiles, querystring, queueLineID, removeFromQueue, removeQueuedPerson, requestQueue, savePin, savePinInQueue, sendQueueInChat, sendQueueInPM;
  ...
  sendQueueInPM = function(queue, user) {
    ...
    return PMManager.queuePMs(msgs, user);
  };
