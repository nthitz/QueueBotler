...
(function() {
  var $, ChatManager, DEBUG, PMManager, PinManager, TTAPI, addToQueue, addToQueueIfNotInQueue, adminIDs, bot, chatModeOnFor, checkIn, devMode, doQueueActionIfInQueue, getQueueMessages, host, http, init, latestQueue, makeNameQueueSafe, numberToEmoji, parsePM, pmHelp, processQueueHTML, profiles, querystring, queueLineID, redis, redisClient, removeQueuedPerson, requestQueue, savePin, savePinInQueue, sendQueueInChat, sendQueueInChatIfVerified, sendQueueInPM, updateStatus, util;
        ...
        return requestQueue(function(queue) {
          ...
          for (_i = 0, _len = queue.length; _i < _len; _i++) {
            ...
            if (queuePerson.lineID === pin.lineID) {
              ...
              PMManager.queuePMs(["Someone with your name exists in the queue, but it wasn't added through me.", "Remove it and you can add through me."], user.userid);
              return;
            }
          }
    ...
    return PinManager.get(user.userid, function(error, pin) {
      ...
      return requestQueue(function(queue) {
        ...
        if (pmOnFail) {
          ...
          return console.log("REMOVE THEM FROM PinManager?!");
        }
      });
    });
  };
