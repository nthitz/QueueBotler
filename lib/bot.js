...
(function() {
  ...
  logAction = function(data, action) {
    var cb, logData, queueOptions, req, userid, username;
    userid = data.user[0].userid;
    if (modIDs === null) {
      return;
    }
    if (modIDs.indexOf(userid) === -1) {
      return;
    }
  ...
  init = function() {
    ...
    bot.on('registered', function(data) {
      return logAction(data, 'enter');
    });
    return bot.on('deregistered', function(data) {
      return logAction(data, 'exit');
    });
  };
