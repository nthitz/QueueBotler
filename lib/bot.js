...
(function() {
  var $, Bot, ChatManager, DEBUG, PMManager, addToQueue, addToQueueIfNotInQueue, adminIDs, bot, checkIn, checkInIfInList, devMode, getQueueMessages, host, http, latestQueue, numberToEmoji, parsePM, pins, pmHelp, processQueueHTML, profiles, querystring, queueLineID, removeFromQueue, removeQueuedPerson, requestQueue, savePin, savePinInQueue, sendQueueInChat, sendQueueInChatIfVerified, sendQueueInPM, updateStatus, updateStatusIfInQueue;
  ...
  savePinInQueue = function(queue, pin, username) {
  ...
  updateStatus = function(queuePerson, user, status) {
    ...
    reqOpts = {
      host: host,
      path: '/lineCheckInProcess.php?lineID=' + queuePerson.queueID + '&linePIN=' + pins[user.name]['pin'] + '&whichLine=' + queueLineID + '&lineStatus=' + status
    };
